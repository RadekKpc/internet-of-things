...
def main():
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        mqttc.subscribe("bathroom/light/lamp1")
        mqttc.subscribe("bathroom/light/lamp2")
        mqttc.subscribe("zone2/light")
        mqttc.subscribe("bathroom/service")
        mqttc.publish("bathroom/service", "Light controller bathroom is working properly", 0, False)
    ...
    mqttc = mqtt.Client("kopec-radek-bathroom-1")
    mqttc.will_set("bathroom/service", "Light controller bathroom is not working", False, 0)
