...
def main():
    ...
    def switch_2_pressed():
        mqttc.publish("zone2/light", "off", 0, False)
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        mqttc.subscribe("lobby/light/lamp1")
        mqttc.subscribe("zone2/light")
        mqttc.subscribe("lobby/service")
        mqttc.publish("lobby/service", "Light controller lobby is working properly", 0, False)
    ...
    mqttc = mqtt.Client("kopec-radek-lobby-1")
    mqttc.will_set("lobby/service", "Light controller lobby is not working", False, 0)
