...
def main():
    ...
    def on_connect(client, userdata, flags, rc):
        ...
        mqttc.subscribe("kitchen/light/lamp1")
        mqttc.subscribe("zone2/light")
        mqttc.subscribe("zone1/light")
        mqttc.subscribe("kitchen/service")
        mqttc.publish("kitchen/service", "Light controller kitchen is working properly", 0, False)
    ...
    mqttc = mqtt.Client("kopec-radek-kitchen-1")
    mqttc.will_set("kitchen/service", "Light controller kitchen is not working", False, 0)
